...
/**
 * Type guard to check if a value is an ExchangeMap
 */
function isExchangeMap(value: any): value is ExchangeMap {
  if (!value || typeof value !== "object") return false;
  for (const exchange in value) {
    if (
    ...
    for (const url in value[exchange]) {
      if (typeof value[exchange][url] !== "string") {
        return false;
      }
    }
  }
...
/**
 * Safely merge two ExchangeMaps
 */
function mergeExchangeMaps(map1: ExchangeMap, map2: any): ExchangeMap {
  if (!isExchangeMap(map2)) {
    // If second map is not valid, return first map as-is
    return map1;
  }

  const result: ExchangeMap = { ...map1 };

  for (const [exchange, endpoints] of Object.entries(map2)) {
    if (!result[exchange]) {
      result[exchange] = { ...endpoints };
    } else {
      result[exchange] = { ...result[exchange], ...endpoints };
    }
  }
...
export default class Exchange {
    ...
    urlToMethodMap: ExchangeMap = {
        ...
        "delta": {
            ...
            "https://api.delta.exchange/v2/trades/": "fetchTrades",
            "https://api.delta.exchange/v2/trades/BTCUSDT": "fetchTrades",
            "https://api.delta.exchange/v2/l2orderbook/": "fetchOrderBook",
            ...
            "https://api.delta.exchange/v2/tickers/": "fetchTicker",
        ...
        "whitebit": {
            ...
            "https://whitebit.com/api/v4/public/trades/": "fetchTrades",
            "https://whitebit.com/api/v4/public/trades/BTC_PERP": "fetchTrades",
            "https://whitebit.com/api/v4/public/orderbook/": "fetchOrderBook",
        ...
        "defx": {
            ...
            "https://api.defx.com/v1/auth/api/order/": "fetchOrder",
            "https://api.defx.com/v1/auth/api/orders": "fetchCanceledOrders",
            "https://api.defx.com/v1/auth/api/position/": "closePosition",
        ...
        "yobit": {
            ...
            "https://yobit.net/api/3/trades/": "fetchTrades",
            "https://yobit.net/api/3/depth/": "fetchOrderBook",
            "https://yobit.net/api/3/ticker/": "fetchTicker",
            "https://yobit.net/api/3/ticker/-eth_usdt": "fetchTickers"
        },
        "bybit": {
        ...
        "cryptomus": {
            ...
            "https://api.cryptomus.com/v2/user-api/exchange/orders/": "cancelOrder"
        },
        "phemex": {
        ...
        "woo": {
            ...
            "https://api.woox.io/v1/public/orderbook/SPOT_": "fetchOrderBook",
            "https://api.woox.io/v1/public/orderbook/PERP_": "fetchOrderBook",
            ...
            "https://api.woox.io/v1/public/funding_rate/PERP_": "fetchFundingRate",
            ...
            "https://api.staging.woox.io/v1/public/funding_rate/PERP_": "fetchFundingInterval"
        },
        "vertex": {
        ...
        "btcalpha": {
            ...
            "https://btc-alpha.com/api/v1/orderbook/": "fetchOrderBook",
            "https://btc-alpha.com/api/v1/ticker/": "fetchTickers",
            "https://btc-alpha.com/api/charts//5/chart/": "fetchOHLCV"
        },
        "kraken": {
        ...
        "bitopro": {
            "https://api.bitopro.com/v3/trades/": "fetchTrades",
            "https://api.bitopro.com/v3/order-book/": "fetchOrderBook",
            "https://api.bitopro.com/v3/tickers/": "fetchTicker",
            "https://api.bitopro.com/v3/tickers": "fetchTickers",
            "https://api.bitopro.com/v3/trading-history/": "fetchOHLCV",
    ...
    async fetch(url, method = 'GET', headers: any = undefined, body: any = undefined) {
        ...
        try {
            ...
            const idMap = this.urlToMethodMap[this.id] ?? {};
