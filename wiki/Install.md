...
* jsDelivr: https://cdn.jsdelivr.net/npm/ccxt@0.0.6/dist/ccxt.browser.min.js
* unpkg: https://unpkg.com/ccxt@0.0.6/dist/ccxt.browser.min.js
...
```html
<script type="text/javascript" src="https://cdn.jsdelivr.net/npm/ccxt@0.0.6/dist/ccxt.browser.min.js"></script>
```
